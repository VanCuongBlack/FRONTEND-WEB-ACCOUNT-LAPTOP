import { Bot, Gamepad2, Gift, Laptop, Monitor, Sparkles } from 'lucide-react'

const CATEGORIES = [
  { id: 'pc-gaming', label: 'PC Gaming', href: '/laptops', icon: Monitor },
  { id: 'laptop', label: 'Laptop', href: '/laptops', icon: Laptop },
  { id: 'account-ai', label: 'Account AI', href: '/accounts', icon: Bot },
  { id: 'game-account', label: 'Game Account', href: '/accounts', icon: Gamepad2 },
  { id: 'gift-card', label: 'Gift Card', href: '/accounts', icon: Gift },
...
export default function CategoryBar() {
  return (
    <section className="mx-auto max-w-[1840px] px-4 pb-5 sm:px-6">
      <div className="grid grid-cols-3 gap-3 rounded-[24px] bg-[#211b42] px-4 py-5 shadow-[0_14px_35px_rgba(0,0,0,0.22)] sm:grid-cols-6">
        {CATEGORIES.map((cat) => {
          const Icon = cat.icon
          return (
            <a
