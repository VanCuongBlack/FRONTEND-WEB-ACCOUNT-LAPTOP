...
export default function CheckoutPage() {
  ...
  const handleConfirmPayment = async () => {
    ...
    if (hasPhysicalItems && !shippingAddress.trim()) {
      showNotice('Vui lòng nhập địa chỉ giao hàng cho đơn PC/Laptop.')
      return
    }
              ...
              {hasPhysicalItems ? (
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full resize-none rounded-xl border border-[#3d63ff]/30 bg-[#151033] px-4 py-3 text-sm text-white outline-none placeholder:text-[#8d86b6] focus:border-[#3783EC]"
                  />
                </div>
              ) : (
